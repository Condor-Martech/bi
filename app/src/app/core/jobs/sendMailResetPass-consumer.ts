  ...
  <html>
    <body>
      <div style="margin:0 auto; max-width: 650px; height: auto; border-radius:10px; overflow:hidden">
              <div style="text-align: center; background:#0b479c; padding:50px 0">
            <img align-items="center" src="${SendMailResetConsumer.logo}" alt="logo-condor" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; display: inline-block !important; border: none; height: auto; max-width: 100%;" />
              <div style="background-color:#fff">
              <h1 style="padding: 20px ; line-height: 140%; text-align: center; font-weight: normal; font-family: arial, helvetica, sans-serif; font-size: 22px;">
                Olá, ${data.name}!
              </h1>
              ...
              <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="font-size: 14px; line-height: 140%;"> Sua senha foi resetada com sucesso </p>
                <p style="font-size: 14px; line-height: 140%;"> Sua nova senha: ${data.password} </p>
              </div>
